...
This beta focuses on validating core profile, session, and work-order flows for salvage/mining operations.
...
- Profile header polish with role/ship controls and financial summary card
- Role dropdown with persistence
